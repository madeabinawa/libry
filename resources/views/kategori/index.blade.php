                ...
                <table class="min-w-max w-full table-auto rounded">
                    ...
                    <tbody class="text-gray-600 text-sm font-light">
                        ...
                        <tr class="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                            ...
                            <td class="py-3 px-6 text-left">
                                <div class="flex items-center">
                                    <span class="font-medium">{{$item->jenis_kategori}}</span>
                                </div>
                            </td>
                            <td class="py-3 px-6 text-center">
                                <div class="flex item-center justify-center">
                                    ...
                                    <button onclick="showUpdateCategoryForm({{$item}})">
                                        <div class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="w-auto sm:w-full relative px-4 py-10 bg-white mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
                <div class="max-w-xl mx-auto">
                    ...
                    <div class="divide-y divide-gray-200">
                        <form id="kategoriForm" name="kategoriForm" enctype="multipart/form-data" method="POST">
                            <div class="text-base pb-4 leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                <div class="flex flex-col">
                                    {{-- CSRF TOKEN --}}
                                    <input type="hidden" name="_token" id="_token" value="{{ csrf_token() }}" />

                                    <input name="id_kategori" id="id_kategori" type="hidden"
                                        class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600">

                                    <label class="leading-loose">Jenis Kategori</label>
                                    <input name="jenis_kategori" id="jenis_kategori" type="text"
                                        class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"
                            ...
                            <div class="flex flex-col-reverse md:flex-row pt-4">
                                ...
                                <div id="custom_button" class="w-full md:w-auto items-center">
                                    ...
                                    <button type="submit" id="tambah_btn" onclick="storeCategory()"
                                    ...
                                    <button type="submit" id="simpan_btn" onclick="updateCategory()"
...
@section('javascript')
<script src={{asset("js/ajax/kategori.js")}}></script>
@endsection
